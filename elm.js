...
var $author$project$Main$Overview = {$: 'Overview'};
var $author$project$Recipe$description = function (_v0) {
	var recipe = _v0.a;
...
var $author$project$Recipe$problemToString = function (p) {
	switch (p.$) {
		case 'Expecting':
			var s = p.a;
			return 'expecting \'' + (s + '\'');
...
var $author$project$Recipe$deadEndToString = function (deadend) {
	return $author$project$Recipe$problemToString(deadend.problem) + (' at row ' + ($elm$core$String$fromInt(deadend.row) + (', col ' + $elm$core$String$fromInt(deadend.col))));
};
...
var $author$project$Recipe$deadEndsToString = function (deadEnds) {
	return $elm$core$String$concat(
		A2(
			$elm$core$List$intersperse,
			'; ',
			A2($elm$core$List$map, $author$project$Recipe$deadEndToString, deadEnds)));
};
...
var $author$project$Recipe$Recipe = function (a) {
	return {$: 'Recipe', a: a};
};
...
var $author$project$Recipe$PlainPart = function (a) {
	return {$: 'PlainPart', a: a};
};
...
var $author$project$Recipe$Ingredient = function (a) {
	return {$: 'Ingredient', a: a};
};
var $author$project$Recipe$IngredientPart = function (a) {
	return {$: 'IngredientPart', a: a};
};
...
var $author$project$Recipe$parseOptional = function (parser) {
...
var $author$project$Recipe$Amount = function (a) {
	return {$: 'Amount', a: a};
};
var $author$project$Recipe$Measure = F2(
	function (a, b) {
		return {$: 'Measure', a: a, b: b};
	});
var $author$project$Recipe$Description = function (a) {
...
var $author$project$Recipe$parseUntil = function (endChars) {
	return A2(
		$elm$parser$Parser$andThen,
		function (text) {
			return $elm$core$String$isEmpty(text) ? $elm$parser$Parser$problem('Inside text cannot be empty') : $elm$parser$Parser$succeed(text);
		},
		$elm$parser$Parser$getChompedString(
			$elm$parser$Parser$chompWhile(
				function (c) {
					return !A2($elm$core$Set$member, c, endChars);
				})));
};
var $elm$core$String$trim = _String_trim;
var $author$project$Recipe$parseDescription = function (endChars) {
	return A2(
		$elm$parser$Parser$keeper,
		$elm$parser$Parser$succeed(
			function (inside) {
				return $author$project$Recipe$Description(
					$elm$core$String$trim(inside));
			}),
		$author$project$Recipe$parseUntil(endChars));
};
...
var $author$project$Recipe$parseFloat = $elm$parser$Parser$backtrackable(
	$elm$parser$Parser$oneOf(
		_List_fromArray(
			[
				...
				$elm$parser$Parser$andThen,
				function (_v0) {
					return $elm$parser$Parser$problem('A float cannot begin with e');
				},
				$elm$parser$Parser$symbol('e')),
				$elm$parser$Parser$float
			])));
var $author$project$Recipe$parseQuantity = function (endChars) {
	return $elm$parser$Parser$oneOf(
		_List_fromArray(
			[
				A2(
				...
				A2(
					...
					$elm$parser$Parser$succeed(
						F2(
							function (number, maybeUnit) {
								if (maybeUnit.$ === 'Just') {
									var unit = maybeUnit.a;
									return A2($author$project$Recipe$Measure, number, unit);
								} else {
									return $author$project$Recipe$Amount(number);
								}
							})),
					$author$project$Recipe$parseFloat),
				$author$project$Recipe$parseOptional(
					A2(
						$elm$parser$Parser$keeper,
						A2(
						...
						$author$project$Recipe$parseUntil(endChars)))),
				$author$project$Recipe$parseDescription(endChars)
			]));
};
var $author$project$Recipe$parseWhitespace = $elm$parser$Parser$chompWhile(
	function (c) {
		return _Utils_eq(
			c,
...
var $author$project$Recipe$parseIngredient = A2(
	$elm$parser$Parser$keeper,
	A2(
		$elm$parser$Parser$keeper,
		A2(
			...
			A2(
				...
				$elm$parser$Parser$succeed(
					F3(
						function (text, maybeQuantity, maybeListName) {
							return $author$project$Recipe$IngredientPart(
								$author$project$Recipe$Ingredient(
									{
										listName: maybeListName,
										quantity: maybeQuantity,
										text: $elm$core$String$trim(text)
									}));
						})),
				$elm$parser$Parser$symbol('<')),
			$author$project$Recipe$parseUntil(
			...
			A2(
				...
				A2(
					...
					A2(
						...
						$elm$parser$Parser$succeed($elm$core$Basics$identity),
						$elm$parser$Parser$symbol(':')),
					$author$project$Recipe$parseWhitespace),
				$author$project$Recipe$parseQuantity(
					$elm$core$Set$fromList(
						_List_fromArray(
							[
								_Utils_chr(';'),
	...
	A2(
		...
		$elm$parser$Parser$symbol('>')));
var $author$project$Recipe$parsePlain = function (endChars) {
	return A2(
		$elm$parser$Parser$andThen,
		function (text) {
			return $elm$core$String$isEmpty(text) ? $elm$parser$Parser$problem('Text cannot be empty') : $elm$parser$Parser$succeed(
				$author$project$Recipe$PlainPart(text));
		},
		$elm$parser$Parser$getChompedString(
			$elm$parser$Parser$chompWhile(
				function (c) {
...
var $author$project$Recipe$parseRecursion = function (_v0) {
	var next = _v0.a;
	var paragraphs = _v0.b;
	return $elm$parser$Parser$oneOf(
		_List_fromArray(
			[
				A2(
				...
				function (_v2) {
					return $elm$parser$Parser$Loop(
						_Utils_Tuple2(
							A2(
								$elm$core$List$cons,
								$author$project$Recipe$PlainPart(' '),
								next),
							paragraphs));
				},
				$elm$parser$Parser$symbol('\n')),
				...
				$elm$parser$Parser$succeed(
					function (ingred) {
						return $elm$parser$Parser$Loop(
							_Utils_Tuple2(
								A2($elm$core$List$cons, ingred, next),
								paragraphs));
					}),
				$author$project$Recipe$parseIngredient),
				A2(
				$elm$parser$Parser$keeper,
				$elm$parser$Parser$succeed(
					function (plain) {
						return $elm$parser$Parser$Loop(
							_Utils_Tuple2(
								A2($elm$core$List$cons, plain, next),
								paragraphs));
					}),
				$author$project$Recipe$parsePlain(
					$elm$core$Set$fromList(
						_List_fromArray(
							[
								_Utils_chr('<'),
...
var $author$project$Recipe$parseRecipe = A2(
	$elm$parser$Parser$keeper,
	A2(
		$elm$parser$Parser$keeper,
		A2(
	...
	A2(
		...
		$author$project$Recipe$parseRecursion));
...
var $author$project$Recipe$parse = function (input) {
	return A2(
...
var $author$project$Main$update = F2(
	function (msg, model) {
		var toState = function (route) {
			return A2(
				$elm$core$Maybe$withDefault,
				model.state,
				A2($author$project$Main$stateFromRoute, model.recipes, route));
		};
		switch (msg.$) {
			case 'DeleteRecipe':
				var title = msg.a;
				return _Utils_Tuple2(
					_Utils_update(
						model,
						{
							recipes: A2($elm$core$Dict$remove, title, model.recipes),
							state: toState($author$project$Main$OverviewRoute)
						}),
					$author$project$Main$delete(title));
			case 'Edited':
				var code = msg.a;
			...
			case 'Save':
				...
				if (_v2.$ === 'Edit') {
					var code = _v2.a.code;
					var _v3 = $author$project$Recipe$parse(code);
					if (_v3.$ === 'Ok') {
						var recipe = _v3.a;
						var title = $author$project$Recipe$title(recipe);
						var parts = $author$project$Recipe$description(recipe);
						return _Utils_Tuple2(
							_Utils_update(
								model,
								{
									recipes: A3(
										...
										title,
										_Utils_Tuple2(parts, code),
										model.recipes),
									state: $author$project$Main$Recipe(recipe)
								}),
						...
						return _Utils_Tuple2(
							_Utils_update(
								model,
								{
									state: $author$project$Main$Edit(
										{
											code: code,
...
var $author$project$Main$bodyFontStyle = $rtfeldman$elm_css$Css$fontFamilies(
	_List_fromArray(
		['Zilla Slab', 'Palatino', 'serif']));
...
var $author$project$Main$Edited = function (a) {
	return {$: 'Edited', a: a};
};
...
var $author$project$Main$borderStyle = $rtfeldman$elm_css$Css$batch(
	_List_fromArray(
		[
			A2(
			...
			A3($rtfeldman$elm_css$Css$hsl, 0, 0, 0)),
...
var $author$project$Main$clickableStyle = $rtfeldman$elm_css$Css$batch(
	_List_fromArray(
		[
...
var $author$project$Main$headingFontStyle = $rtfeldman$elm_css$Css$fontFamilies(
	_List_fromArray(
...
var $author$project$Main$linkUnstyle = $rtfeldman$elm_css$Css$batch(
	_List_fromArray(
		[
...
var $author$project$Main$buttonStyle = $rtfeldman$elm_css$Css$batch(
	_List_fromArray(
		[
			$author$project$Main$borderStyle,
			$author$project$Main$clickableStyle,
			A4(
			$rtfeldman$elm_css$Css$boxShadow4,
			$rtfeldman$elm_css$Css$zero,
			$rtfeldman$elm_css$Css$rem(0.1),
			$rtfeldman$elm_css$Css$rem(0.1),
			A4($rtfeldman$elm_css$Css$hsla, 0, 0, 0, 0.3)),
			$rtfeldman$elm_css$Css$hover(
			_List_fromArray(
				[
					$rtfeldman$elm_css$Css$backgroundColor(
					A4($rtfeldman$elm_css$Css$hsla, 0, 0, 0.5, 0.1)),
					A4(
					$rtfeldman$elm_css$Css$boxShadow4,
					$rtfeldman$elm_css$Css$zero,
					$rtfeldman$elm_css$Css$rem(0.1),
			...
			$author$project$Main$headingFontStyle,
			$rtfeldman$elm_css$Css$fontSize(
			$rtfeldman$elm_css$Css$rem(1)),
			$author$project$Main$linkUnstyle
		]));
...
var $author$project$Main$viewEditRecipe = F2(
		...
		return A2(
			...
			_List_fromArray(
				[
					...
					_List_fromArray(
						[
							$rtfeldman$elm_css$Html$Styled$Events$onInput($author$project$Main$Edited),
					...
					_List_Nil),
					A2($author$project$Main$button, 'Save', $author$project$Main$Save)
				]));
	});
var $author$project$Main$DeleteRecipe = function (a) {
...
var $author$project$IngredientMap$addMeasure = F3(
	function (amount, unit, measures) {
		return A3(
			$elm$core$Dict$update,
			unit,
			function (maybeExisting) {
				return $elm$core$Maybe$Just(
					A2($elm$core$Maybe$withDefault, 0, maybeExisting) + amount);
			},
			measures);
	});
var $author$project$IngredientMap$addQuantity = F2(
	function (_new, existing) {
		switch (_new.$) {
			case 'Description':
				var description = _new.a;
				return _Utils_update(
					existing,
					{
						descriptions: A2($elm$core$List$cons, description, existing.descriptions)
					});
			case 'Amount':
				var amount = _new.a;
				return _Utils_update(
					existing,
					{
						amount: $elm$core$Maybe$Just(
							A2($elm$core$Maybe$withDefault, 0, existing.amount) + amount)
					});
			default:
				var amount = _new.a;
				var unit = _new.b;
				return _Utils_update(
					existing,
					{
						measures: A3($author$project$IngredientMap$addMeasure, amount, unit, existing.measures)
					});
		}
	});
var $author$project$IngredientMap$emptyQuantities = {amount: $elm$core$Maybe$Nothing, descriptions: _List_Nil, measures: $elm$core$Dict$empty};
var $author$project$IngredientMap$fromList = function (ingredients) {
	return A3(
		$elm$core$List$foldl,
		F2(
			function (_v0, accumulated) {
				var name = _v0.a;
				var maybeQuantity = _v0.b;
				return A3(
					$elm$core$Dict$update,
					name,
					function (maybeExisting) {
						var existing = A2($elm$core$Maybe$withDefault, $author$project$IngredientMap$emptyQuantities, maybeExisting);
						return $elm$core$Maybe$Just(
							function () {
								if (maybeQuantity.$ === 'Just') {
									var quantity = maybeQuantity.a;
									return A2($author$project$IngredientMap$addQuantity, quantity, existing);
								} else {
									return existing;
								}
							}());
...
var $author$project$Recipe$getListName = function (_v0) {
	var ingred = _v0.a;
	return A2($elm$core$Maybe$withDefault, ingred.text, ingred.listName);
};
var $author$project$Recipe$getQuantity = function (_v0) {
	var ingred = _v0.a;
	return ingred.quantity;
};
var $author$project$Recipe$ingredients = function (parts) {
	return A2(
		$elm$core$List$filterMap,
		function (part) {
			if (part.$ === 'IngredientPart') {
				var ingred = part.a;
				return $elm$core$Maybe$Just(ingred);
			} else {
				return $elm$core$Maybe$Nothing;
			}
		},
...
var $author$project$IngredientMap$fromDescription = function (parts) {
	return $author$project$IngredientMap$fromList(
		A2(
			$elm$core$List$map,
			function (ingredient) {
				return _Utils_Tuple2(
					$author$project$Recipe$getListName(ingredient),
					$author$project$Recipe$getQuantity(ingredient));
			},
			$author$project$Recipe$ingredients(parts)));
};
var $author$project$Recipe$getText = function (_v0) {
	var ingred = _v0.a;
	return ingred.text;
};
...
var $author$project$Main$headingStyle = $rtfeldman$elm_css$Css$batch(
	_List_fromArray(
		[
			$author$project$Main$headingFontStyle,
...
var $author$project$Main$stringFromRoute = function (route) {
	switch (route.$) {
		case 'OverviewRoute':
			return '#';
		case 'RecipeRoute':
			var title = route.a;
			return '#recipe:' + $elm$url$Url$percentEncode(title);
		case 'NewRoute':
			return '#new';
		default:
			var title = route.a;
			return '#edit:' + $elm$url$Url$percentEncode(title);
	}
};
var $author$project$Main$linkButton = F2(
	function (text, route) {
		return A2(
			...
			_List_fromArray(
				[
					...
					$author$project$Main$stringFromRoute(route)),
					$rtfeldman$elm_css$Html$Styled$Attributes$css(
					_List_fromArray(
						[$author$project$Main$buttonStyle]))
				]),
...
var $author$project$Recipe$map = F2(
	function (f, _v0) {
		var recipe = _v0.a;
		return A2(
			$elm$core$List$map,
			function (paragraph) {
				return A2($elm$core$List$map, f, paragraph);
			},
			recipe.description);
	});
...
var $author$project$Main$ul = F3(
	function (styles, attributes, children) {
		return A2(
...
var $author$project$Main$viewRecipe = function (recipe) {
	var ingredientsView = A3(
		$author$project$Main$ul,
		_List_Nil,
		_List_Nil,
		A2(
			$elm$core$List$map,
			function (_v1) {
				var name = _v1.a;
				var quantities = _v1.b;
				var measures = A2(
					$elm$core$List$map,
					function (_v2) {
						var unit = _v2.a;
						var unitAmount = _v2.b;
						return $elm$core$String$fromFloat(unitAmount) + (' ' + unit);
					},
					$elm$core$Dict$toList(quantities.measures));
				var descriptions = quantities.descriptions;
				var amount = A2(
					$elm$core$Maybe$withDefault,
					_List_Nil,
					A2(
			...
			$elm$core$Dict$toList(
				$author$project$IngredientMap$fromDescription(
					$author$project$Recipe$description(recipe)))));
	var descriptionView = A2(
		$elm$core$List$map,
		function (paragraph) {
			return A2($rtfeldman$elm_css$Html$Styled$p, _List_Nil, paragraph);
		},
		A2(
			$author$project$Recipe$map,
			function (recipePart) {
				if (recipePart.$ === 'PlainPart') {
					var text = recipePart.a;
					return $rtfeldman$elm_css$Html$Styled$text(text);
				} else {
					var ingredient = recipePart.a;
					return $rtfeldman$elm_css$Html$Styled$text(
						$author$project$Recipe$getText(ingredient));
				}
			},
			recipe));
	return A2(
					...
					[
						...
						_List_fromArray(
							[
								...
								$rtfeldman$elm_css$Html$Styled$Attributes$href(
								$author$project$Main$stringFromRoute($author$project$Main$OverviewRoute))
							]),
						_List_fromArray(
							[
								$rtfeldman$elm_css$Html$Styled$text('<< Back to list')
							])),
						A2(
						$rtfeldman$elm_css$Html$Styled$div,
						_List_fromArray(
						...
						_List_fromArray(
							[
								A2(
								$author$project$Main$linkButton,
								'Edit',
								$author$project$Main$EditRoute(
									$author$project$Recipe$title(recipe))),
								A2(
								...
								'Delete',
								$author$project$Main$DeleteRecipe(
									$author$project$Recipe$title(recipe)))
							]))
					])),
				A2(
					...
					A2(
						...
						_List_fromArray(
							[
								$rtfeldman$elm_css$Html$Styled$Attributes$css(
								_List_fromArray(
									[$author$project$Main$headingStyle]))
							]),
						_List_fromArray(
							[
								...
								[
									...
									_List_fromArray(
										[
											...
											_List_fromArray(
												[
													$rtfeldman$elm_css$Html$Styled$text('Ingredients')
												]))
										])),
									ingredientsView
								])),
...
var $rtfeldman$elm_css$Css$inside = {listStylePosition: $rtfeldman$elm_css$Css$Structure$Compatible, listStyleTypeOrPositionOrImage: $rtfeldman$elm_css$Css$Structure$Compatible, value: 'inside'};
var $rtfeldman$elm_css$Css$listStylePosition = $rtfeldman$elm_css$Css$prop1('list-style-position');
var $rtfeldman$elm_css$Css$padding = $rtfeldman$elm_css$Css$prop1('padding');
var $author$project$Main$viewRecipeList = function (recipeTitles) {
	return A2(
		$rtfeldman$elm_css$Html$Styled$div,
		_List_Nil,
		_List_fromArray(
			[
				...
				_List_fromArray(
					[
						$rtfeldman$elm_css$Html$Styled$text('Recipe Box')
					])),
				A2(
				$rtfeldman$elm_css$Html$Styled$div,
				_List_fromArray(
				...
				_List_fromArray(
					[
						A2($author$project$Main$linkButton, 'New recipe', $author$project$Main$NewRoute)
					])),
				function () {
				var recipeList = A2(
					$elm$core$List$map,
								...
								[
									...
									_List_fromArray(
										[
											...
											$rtfeldman$elm_css$Html$Styled$Attributes$href(
											$author$project$Main$stringFromRoute(
												$author$project$Main$RecipeRoute(recipeTitle)))
										]),
									_List_fromArray(
										[
											$rtfeldman$elm_css$Html$Styled$text(recipeTitle)
										]))
								]));
					},
					recipeTitles);
				return $elm$core$List$isEmpty(recipeList) ? $rtfeldman$elm_css$Html$Styled$text('You do not have any recipes yet. Create a new recipe!') : A3(
					$author$project$Main$ul,
					_List_fromArray(
						[
							A2($rtfeldman$elm_css$Css$property, 'list-style-type', '\">  \"'),
							$rtfeldman$elm_css$Css$listStylePosition($rtfeldman$elm_css$Css$inside),
				...
				[
					...
					_List_fromArray(
						[
							...
							_List_fromArray(
								[
									$author$project$Main$bodyFontStyle,
									$rtfeldman$elm_css$Css$lineHeight(
									$rtfeldman$elm_css$Css$num(1.4)),
									$rtfeldman$elm_css$Css$maxWidth(
									$rtfeldman$elm_css$Css$em(48)),
					...
					_List_fromArray(
						[
							...
							switch (_v0.$) {
								case 'Overview':
									return $author$project$Main$viewRecipeList(
										$elm$core$Dict$keys(model.recipes));
								case 'Recipe':
									var recipe = _v0.a;
									return $author$project$Main$viewRecipe(recipe);
								default:
									var code = _v0.a.code;
									var error = _v0.a.error;
									return A2($author$project$Main$viewEditRecipe, code, error);
							}
						}()
						]))
				])),
